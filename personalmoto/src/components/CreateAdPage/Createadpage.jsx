...
function Createadpage() {
  ...
  const [capacityFilled, setCapacityFilled] = useState(true);
  ...
  const handleAdFormValues = (prop) => (e) => {
    ...
    if (adFormValues.capacity.length < 3) {
      setCapacityFilled(false);
    } else {
      setCapacityFilled(true);
    }
          ...
          <div className="create-ad-form-box">
            <section>
              <div className="ad-form-header">
                <h1 className="ad-form-heading">Create an ad</h1>
