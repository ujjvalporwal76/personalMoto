    ...
    <div className="seller-card">
      <section className="seller-card-section">
        <div className="seller-heading">
          <h2 className="seller-name">Marcin</h2>
        </div>
        ...
        <section className="seller-card-contact">
          <div className="seller-email-contact">
            <button className="seller-email-send-btn"><GrMail className="seller-contact-icons"size={25}/>Contact the seller</button>
          </div>
        </section>
        <section className="seller-card-contact">
          <div className="seller-phone-contact">
            <button className="seller-phone-call-btn"><IoMdCall className="seller-contact-icons"size={25}/>25218585</button>
          </div>
        </section>
        <section className="seller-card-links">
          <article className="seller-card-location">
            ...
            <a className="seller-location-link" href="#">Tarnowskie Góry, Tarnowskie Góry, Silesia</a>
          </article>
        </section>
      </section>
    </div>
